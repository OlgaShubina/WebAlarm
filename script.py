...
if __name__ =='__main__':
	...
	array = []
	for i in req.CursorCompress("2018-04-19 00:00:00.00000", "2018-04-20 00:00:00.00000", ['VEPP/Currents/e', 'VEPP/Currents/p'], "first_level"):
		try:			
			array.append(i)			
		except(KeyError):
			pass
		
	for ch in ['VEPP/Currents/e', 'VEPP/Currents/p']:	
		try:	
